    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          {data.logoUrl ? (
            <img src={data.logoUrl} alt="logo" className="h-10 w-10 rounded-lg object-cover border border-border" />
          ) : (
                ...
                {editing ? (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center justify-between py-2.5 border-b border-border/50">
                      ...
                      {data.logoUrl ? (
                        <img src={data.logoUrl} alt="logo" className="h-8 w-8 rounded object-cover border border-border" />
                      ) : (
